const app = new Vue({
  ...
  methods: {
    ...
    try {
          ...
          this.microphoneDevice = devices.find(device => device.kind === 'audioinput');
          this.cameraDevice = devices.find(device => device.kind === 'videoinput');

          console.log('Microphone Device ID:', this.microphoneDevice.deviceId);
          console.log('Camera Device ID:', this.cameraDevice.deviceId);
        } catch (error) {
     ...
     */
    //AgoraRTC.Logger.enableLogUpload(true);
    ...
    initializedAgoraListeners() {
      ...
      this.client.on("stream-published", function (evt) {
        console.log('Your stream is published successfully: ' + evt.stream.getId());
